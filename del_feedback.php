...
<body style="background-image: url(img/fon.jpg);background-size: 100%;">
    ...
    <div class="container">
        ...
        <h1 style="text-align:center; color:#E64A19; margin: 50px;">Удаление отзыва</h1>
        <?php
 include("connect.php");
 $table = "feedback";
 ...
 echo ("
        <table class=\"table table-hover\">
          <thead class=\"thead-default\">
            <tr>
              <th style=\"color:#E64A19;\">Имя пользователя</th>
              <th style=\"color:#E64A19;\">Имя тура</th>
              <th style=\"color:#E64A19;\">Оценка</th>
              <th style=\"color:#E64A19;\">Текст отзыва</th>
       ...
       echo "<tr>";
        ...
        echo " <td>".$row['mark']."</td>";
         echo "<td>".$row['text']."</td>";
           ...
           echo "<td><a name=\"del\" href=\"del_feedback.php?del=".$row['id']."\">Удалить</a></td>\n";
           echo "</tr>\n";
       }
       echo ("</table>\n");
